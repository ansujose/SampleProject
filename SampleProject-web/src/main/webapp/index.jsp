...
<%@page import="com.dell.SampleProject.util.Version"%><html>
<%
	/*
...
<title>SampleProject <%=Version.VALUE%></title>
</head>
...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
        	<div class="container">
				<a class="brand" href="${pageContext.request.contextPath}">SampleProject</a>
			</div>
		</div>
	</div>
	<div class="container">
